    ...
    game:{
      ...
      init(canvasEle, appComponent){
            ...
            function preload() {
                ...
                game.load.image('enemyBullet', 'assets/game/images/enemy-bullet.png');
                game.load.spritesheet('invader', 'assets/game/images/invader32x32x4.png', 32, 32);
                game.load.image('ship', 'assets/game/images/player.png');
                game.load.spritesheet('kaboom', 'assets/game/images/explode.png', 128, 128);
                game.load.image('starfield', 'assets/game/images/starfield.png');
                game.load.image('cyberglow', 'assets/game/images/tron.png');


                // load music into buffer
                assets.ready.music.main = game.load.audio('music-main', ['assets/game/music/zombies-in-space.ogg']);
                game.load.audio('powerupfx', ['assets/sound/Powerup4.ogg']);
                game.load.audio('select', ['assets/sound/Pickup_Coin.ogg']);
                game.load.audio('smallExplosion', ['assets/sound/quietExplosion.ogg'])
                game.load.audio('bigExplosion', ['assets/sound/Explosion3.ogg'])
                game.load.audio('laser', ['assets/sound/Laser_Shoot78.ogg'])
                game.load.audio('hit', ['assets/sound/Hit_Hurt11.ogg'])
