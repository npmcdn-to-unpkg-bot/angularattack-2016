    ...
    game:{
      ...
      init(canvasEle, appComponent){
            ...
            function preload() {
                ...
                game.load.image('ship', 'assets/game/images/ship.png')
                game.load.image('gametitle', 'assets/images/angular-attack-title.png')
                game.load.image('purewhite', 'assets/game/images/purewhite.png')
                game.load.image('pureblack', 'assets/game/images/pureblack.png')

                game.load.image('zwcats1', 'assets/game/zerowing/zw-cats.jpg')
                game.load.image('zwcats2', 'assets/game/zerowing/zw-cats2.jpg')
                game.load.image('zwoperator1', 'assets/game/zerowing/zw-operator1.jpg')
                game.load.image('zwoperator2', 'assets/game/zerowing/zw-operator2.jpg')
                game.load.image('zwoperator3', 'assets/game/zerowing/zw-operator3.jpg')
                game.load.image('zwearth', 'assets/game/zerowing/earth.jpg')
                game.load.image('zwcity', 'assets/game/zerowing/city.png')

                game.load.image('cyberglow', 'assets/game/images/cyberglow.png');
                game.load.image('bullet', 'assets/game/images/bullet.png');

                // load music into buffer
                assets.ready.music.main = game.load.audio('music-main', ['assets/game/music/random-encounter.ogg']);
                assets.ready.music.intro = game.load.audio('intro-music', ['assets/game/music/far-sight.ogg']);
                assets.ready.music.gameplay = game.load.audio('gameplay-music', ['assets/game/music/zombies-in-space.ogg']);
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        ...
                        content = [
                            "      ",
                            "The year was 20XX.",
                            "It was the moment that would end an era.",
                            "The Angular Attack competition had started.",
                            " ",
                            "That's when it happened.",
                            "Bugs of every kind swarmed the deployment procedure.",
                            " ",
                            "Surge: \"How are you gentlemen?\"",
                            "Surge: \"All your code are belong to us.\"",
                            "Surge: \"You have no chance to revert make your time.\"",
                            "Surge: \"Ha ha ha ha...\"",
                            "",
                            "Manager: \"Take off every dev.\"",
