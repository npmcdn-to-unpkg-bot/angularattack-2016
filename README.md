...
* `git clone git@github.com:rumblex/angularattack2016-totallynotarobot.git`

* `cd angularattack2016-totallynotarobot`
...
If you receive an error message `"You do not have permission to publish to totallynotarobot.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add himowa@gmail.com,allen.acr@gmail.com`
